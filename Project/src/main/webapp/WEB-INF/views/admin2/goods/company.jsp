...
<head>
   ...
   function del(seq) {
      ...
      if (chk) {
         location.href='companyDelete?userId='+seq;
      }
   }   
</script>
</head>
                            ...
                            <div class="card">
                                ...
                                <div class="content table-responsive table-full-width">
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                    <button type="button" value="삭제" id="delbtn" onclick="del('${companyList.userId}')">삭제</button>
                                    </td>
                                    </tr>
                                 </c:forEach>
                                        </tbody>
