...
<body>
   ...
   <div id="mainWrapper">
      ...
      <div class="t1">
         ...
         <div id='write-btn'>
            <a href="/qnaboard/writeView"> <input type='button'
                        ...
                        <tbody>
                           ...
                           <c:forEach items="${list}" var="list">
                              <tr>
                                 ...
                                 <td data-title="title">[<c:out value="${list.tnf }" />]
                                 <c:if
													test="${member.userId != null && mp_member.userId eq mp_board.writer}">
													<a
														href="/qnaboard/readView?bno=${list.bno}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}">
														<c:out value="${list.title}" />
													</a>
												</c:if> <c:if test="${member.userId == null}">
													<a href="/qnaboard/needLogin"> <c:out
															value="${list.title}" />
													</a>
												</c:if> 
                                 ...
                                 <td data-title="date"><fmt:formatDate value="${list.regdate}"
