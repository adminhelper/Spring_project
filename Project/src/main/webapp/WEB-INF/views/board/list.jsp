	...
	<div id="mainWrapper">
		...
		<div class="t1">
			...
			<c:if test="${member.userId != null }">
				<div id='write-btn'>
					<a href="/board/writeView"> <input type='button' class="text_w"
						value='글쓰기' />
					</a>
				</div>
			</c:if>
			...
			<div class="test2">
				<div id="demo">
					...
					<form role="form" method="get"
						class="table-responsive-vertical-form">
									...
									<c:forEach items="${list}" var="list">
										<tr>
											...
											<c:if
													...
													<a href="/board/needLogin"> <c:out
															value="${list.title}" />
													</a>
												</c:if> 
												
												<span class="badge bg-teal"> <i
													class="fa fa-comment-o"></i>+${list.reply_cnt}
											</span></td>
